...
* The original package name 'com.lookme.lookme-backend' is invalid and this project uses 'com.lookme.lookme_backend' instead.
...
* [WebSocket](https://docs.spring.io/spring-boot/4.0.0-SNAPSHOT/reference/messaging/websockets.html)
* [Spring Web](https://docs.spring.io/spring-boot/4.0.0-SNAPSHOT/reference/web/servlet.html)
* [OAuth2 Client](https://docs.spring.io/spring-boot/4.0.0-SNAPSHOT/reference/web/spring-security.html#web.security.oauth2.client)
